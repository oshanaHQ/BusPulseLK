...
const WorkerAnnouncementsScreen = () => {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.sub}>Manage notices for your passengers</Text>
        </View>
...
export default WorkerAnnouncementsScreen;
